    ...
    private void replaceContents(Map<IFile, Collection<FileTString>> tstringMapping) {
        for (Map.Entry<IFile, Collection<FileTString>> entry : tstringMapping.entrySet()) {
            ...
            try {
                ...
                List<FileTString> sortedTStrings = new ArrayList<>(entry.getValue());
                sortedTStrings.sort((o1, o2) -> (int) (o1.getIndexOffset() - o2.getIndexOffset()));

                for (FileTString tstring : sortedTStrings) {
                    ...
                    if (!last.getValue().equals(tstring.getValue())) {
                        ...
                        String index = contentBuilder.substring(begin, end);
